...
public class LibraryMgrMenuWinListener implements WindowListener {// 目录窗口事件

    private LoginWindow loginWindow;
    private LibraryMgrMenuWindow manMenuWindow;

    public LibraryMgrMenuWinListener(LoginWindow loginWindow, LibraryMgrMenuWindow manMenuWindow) {
